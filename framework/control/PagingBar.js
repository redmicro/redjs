...
Rsd.define('Rsd.control.PagingBar', {
    ...
    items: [
        ...
        {xtype: 'number-index',header:{visible:false}, width: 260,selectedChanged:'goTo', margin: '2 2 2 2'},
        ...
        {xtype: 'label', id: '_pageCount', text: '200',cls:'x-label', border: false, width:30,height:30,margin: '0 5 5 5'},
        {xtype: 'link', tip: '跳转到',text:'转到',handler:'setPageIndex',border:false, width:60, margin: '5 5 5 5'},
        {
            xtype: 'combobox', id:'_pageSize',
            tip: '用于分页的每页记录条数值',label:'每页记录数:',
