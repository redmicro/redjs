        ...
        //2
        {
            ...
            header:{
                ...
                config:{
                    ...
                    html:'<div style="widht:100%;height:100%;"><div style="widht:100%;height:50px;font-size:120%;text-align:center;">服务项目</div><span>用我们的专业和诚信赢得您的信赖，从PC到移动互联网均有您想要的服务</span></div>'
                }
            },
            width:'100%',
            border:false,
    ...
    load:function load()
    {
        //首页数据 
         ...
         var menus = [
            ...
            {flex:1},
            {xtype:'button',text:'登 录',handler:'btn_login',width:90,style:{bottom:20,left:60,fontSize:'90%',backgroundColor:'tansparent'}},
            {xtype:'button',text:'注 册',handler:'btn_register',width:90,style:{bottom:20,left:30,fontSize:'90%',backgroundColor:'tansparent'}}
        ];
